...
$(function() {
	...
	$("#loginForm").validate({
		rules: {
			user_email : {
				required: true,
				remote: "<?=__ROOT__?>/index.php?file=ajax&ajax=user&control=forget",
				email: true
			}
		},
		messages: {
...
<div style="width:100%;" align="center">
    ...
    <!-- LOGIN -->	
    <div class="box-login radius_5 gradient shadow pt_8 gray" style="width:290px">
        <div style="width:97%;">
        	<div class="spacer_10 clean"><!-- SPACER --></div>
            <table cellpadding="0" cellspacing="10" border="0" width="100%">
            	<tr>
                    <td align="left" class="pt_8 shadow">
                        <span class="line_13"><strong>Forgot Password?</strong></span>
                    </td>
                </tr>
                <tr height="38">
                    <td align="left" style="position:absolute; width:255px;">
                        <span class="placeholder pt_8 opacity">Enter your recovery email address</span>
                        <input id="user_email" name="user_email" type="text" class="login_inputtext" maxlength="50" />
                        <label for="user_email" generated="false" class="error placeerror"></label>
                    </td>
                </tr>
                <tr height="40">
                    <td align="center" valign="bottom">
                        <input name="back" type="button" value="Back" class="button" id="back" />
                        <input name="forget" type="submit" value="Send" class="button" />
                    </td>
                </tr>
            </table>
        </div>
